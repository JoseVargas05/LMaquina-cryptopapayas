const styles = {
  ...
  normalText: 'font-rajdhani font-normal text-[24px] text-white',
  footerText: 'font-rajdhani font-medium text-base text-white',
  infoText: 'font-rajdhani font-medium text-lg text-white cursor-pointer',
  ...
  hocContentBox: 'flex flex-1 justify-between bg-siteblack py-8 sm:px-12 px-8 flex-col items-center',
  hocLogo: 'w-[140px] h-[150px] object-contain cursor-pointer ml-auto',
  hocBodyWrapper: 'flex-1 flex justify-center flex-col xl:mt-0 my-16 items-center',
  ...
  cardContainerSmall: 'relative sm:w-[160px] w-[120px] sm:h-[235px] h-[180px] z-0 transition-all',
  ...
  btn: 'hover:text-grey px-4 py-2 rounded-full border-solid border-2 border-white bg-transparent w-fit text-white font-rajdhani font-bold',

  // custom input component
  label: 'font-rajdhani font-semibold text-lg text-white mb-3 mr-2',
  input: 'bg-[#80808040] placeholder:text-white text-white outline-none focus:outline-white p-4 rounded-md sm:max-w-[100%] max-w-full',
  ...
  gameLoadPlayersBox: 'flex justify-evenly items-center mt-5',
  ...
  gameLoadVS: 'font-rajdhani font-extrabold text-white text-7xl mx-2',
