...
import { allCards, Alien, Back } from '../assets';
...
const Card = ({ card, title, restStyles, cardRef, playerTwo }) => (
  <Tilt>
    <div ref={cardRef} className={`${styles.cardContainerSmall} ${restStyles}`}>
      <img src={playerTwo ? Alien : Back} alt="ace_card" className={styles.cardImg} />
