...
import { alertIcon, gameRules, Alien } from '../assets';
    ...
    <>
      ...
      <div className={`${styles.gameInfoSidebar} ${toggleSidebar ? 'translate-x-0' : 'translate-x-full'} ${styles.glassEffect} ${styles.flexBetween} backdrop-blur-3xl`}>
        <div className="flex flex-col">
          ...
          <h3 className={styles.gameInfoHeading}>Tus cartas:</h3>
          <div className={`${styles.cardContainerSmall} mt-3`}>
            <img src={Alien} alt="ace_card" className={styles.cardImg} />
          </div>
        </div>
